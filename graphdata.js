window.graphnodes = [
  {id: "1Lab.Counterexamples.IsIso", label: "1Lab.Counterexamples.IsIso"},
  {id: "1Lab.Counterexamples.Russell", label: "1Lab.Counterexamples.Russell"},
  {id: "1Lab.Counterexamples.Sigma", label: "1Lab.Counterexamples.Sigma"},
  {id: "1Lab.Equiv.Biinv", label: "1Lab.Equiv.Biinv"},
  {id: "1Lab.Equiv.Embedding", label: "1Lab.Equiv.Embedding"},
  {id: "1Lab.Equiv.Fibrewise", label: "1Lab.Equiv.Fibrewise"},
  {id: "1Lab.Equiv.FromPath", label: "1Lab.Equiv.FromPath"},
  {id: "1Lab.Equiv.HalfAdjoint", label: "1Lab.Equiv.HalfAdjoint"},
  {id: "1Lab.Equiv", label: "1Lab.Equiv"},
  {id: "1Lab.HIT.S1", label: "1Lab.HIT.S1"},
  {id: "1Lab.HIT.Sinfty", label: "1Lab.HIT.Sinfty"},
  {id: "1Lab.HIT.Sphere", label: "1Lab.HIT.Sphere"},
  {id: "1Lab.HIT.Suspension", label: "1Lab.HIT.Suspension"},
  {id: "1Lab.HIT.Torus", label: "1Lab.HIT.Torus"},
  {id: "1Lab.HIT.Truncation", label: "1Lab.HIT.Truncation"},
  {id: "1Lab.HLevel.Retracts", label: "1Lab.HLevel.Retracts"},
  {id: "1Lab.HLevel.Sets", label: "1Lab.HLevel.Sets"},
  {id: "1Lab.HLevel.Universe", label: "1Lab.HLevel.Universe"},
  {id: "1Lab.HLevel", label: "1Lab.HLevel"},
  {id: "1Lab.Path.Groupoid", label: "1Lab.Path.Groupoid"},
  {id: "1Lab.Path", label: "1Lab.Path"},
  {id: "1Lab.Prelude", label: "1Lab.Prelude"},
  {id: "1Lab.Reflection.Record", label: "1Lab.Reflection.Record"},
  {id: "1Lab.Reflection", label: "1Lab.Reflection"},
  {id: "1Lab.Rewrite", label: "1Lab.Rewrite"},
  {id: "1Lab.Type.Dec", label: "1Lab.Type.Dec"},
  {id: "1Lab.Type.Pi", label: "1Lab.Type.Pi"},
  {id: "1Lab.Type.Prop", label: "1Lab.Type.Prop"},
  {id: "1Lab.Type.Sigma", label: "1Lab.Type.Sigma"},
  {id: "1Lab.Type", label: "1Lab.Type"},
  {id: "1Lab.Univalence.SIP.Auto", label: "1Lab.Univalence.SIP.Auto"},
  {id: "1Lab.Univalence.SIP.Record.Base", label: "1Lab.Univalence.SIP.Record.Base"},
  {id: "1Lab.Univalence.SIP.Record.Parse", label: "1Lab.Univalence.SIP.Record.Parse"},
  {id: "1Lab.Univalence.SIP.Record.Prop", label: "1Lab.Univalence.SIP.Record.Prop"},
  {id: "1Lab.Univalence.SIP.Record", label: "1Lab.Univalence.SIP.Record"},
  {id: "1Lab.Univalence.SIP", label: "1Lab.Univalence.SIP"},
  {id: "1Lab.Univalence", label: "1Lab.Univalence"},
  {id: "1Lab.intro", label: "1Lab.intro"},
  {id: "Agda.Builtin.Bool", label: "Agda.Builtin.Bool"},
  {id: "Agda.Builtin.Char", label: "Agda.Builtin.Char"},
  {id: "Agda.Builtin.Cubical.HCompU", label: "Agda.Builtin.Cubical.HCompU"},
  {id: "Agda.Builtin.Cubical.Path", label: "Agda.Builtin.Cubical.Path"},
  {id: "Agda.Builtin.Cubical.Sub", label: "Agda.Builtin.Cubical.Sub"},
  {id: "Agda.Builtin.Float", label: "Agda.Builtin.Float"},
  {id: "Agda.Builtin.FromNat", label: "Agda.Builtin.FromNat"},
  {id: "Agda.Builtin.FromNeg", label: "Agda.Builtin.FromNeg"},
  {id: "Agda.Builtin.Int", label: "Agda.Builtin.Int"},
  {id: "Agda.Builtin.List", label: "Agda.Builtin.List"},
  {id: "Agda.Builtin.Maybe", label: "Agda.Builtin.Maybe"},
  {id: "Agda.Builtin.Nat", label: "Agda.Builtin.Nat"},
  {id: "Agda.Builtin.Reflection", label: "Agda.Builtin.Reflection"},
  {id: "Agda.Builtin.Sigma", label: "Agda.Builtin.Sigma"},
  {id: "Agda.Builtin.String", label: "Agda.Builtin.String"},
  {id: "Agda.Builtin.Unit", label: "Agda.Builtin.Unit"},
  {id: "Agda.Builtin.Word", label: "Agda.Builtin.Word"},
  {id: "Agda.Primitive.Cubical", label: "Agda.Primitive.Cubical"},
  {id: "Agda.Primitive", label: "Agda.Primitive"},
  {id: "Algebra.Group.Ab.Free", label: "Algebra.Group.Ab.Free"},
  {id: "Algebra.Group.Ab", label: "Algebra.Group.Ab"},
  {id: "Algebra.Group.Cat.Base", label: "Algebra.Group.Cat.Base"},
  {id: "Algebra.Group.Cat.FinitelyComplete", label: "Algebra.Group.Cat.FinitelyComplete"},
  {id: "Algebra.Group.Cayley", label: "Algebra.Group.Cayley"},
  {id: "Algebra.Group.Free", label: "Algebra.Group.Free"},
  {id: "Algebra.Group.Homotopy.BAut", label: "Algebra.Group.Homotopy.BAut"},
  {id: "Algebra.Group.Homotopy", label: "Algebra.Group.Homotopy"},
  {id: "Algebra.Group.Subgroup", label: "Algebra.Group.Subgroup"},
  {id: "Algebra.Group", label: "Algebra.Group"},
  {id: "Algebra.Lattice", label: "Algebra.Lattice"},
  {id: "Algebra.Magma.Unital.EckmannHilton", label: "Algebra.Magma.Unital.EckmannHilton"},
  {id: "Algebra.Magma.Unital", label: "Algebra.Magma.Unital"},
  {id: "Algebra.Magma", label: "Algebra.Magma"},
  {id: "Algebra.Monoid.Category", label: "Algebra.Monoid.Category"},
  {id: "Algebra.Monoid", label: "Algebra.Monoid"},
  {id: "Algebra.Prelude", label: "Algebra.Prelude"},
  {id: "Algebra.Ring.Base", label: "Algebra.Ring.Base"},
  {id: "Algebra.Semigroup", label: "Algebra.Semigroup"},
  {id: "Algebra.Semilattice", label: "Algebra.Semilattice"},
  {id: "Authors", label: "Authors"},
  {id: "Cat.Abelian.Base", label: "Cat.Abelian.Base"},
  {id: "Cat.Abelian.Images", label: "Cat.Abelian.Images"},
  {id: "Cat.Abelian.Limits", label: "Cat.Abelian.Limits"},
  {id: "Cat.Base", label: "Cat.Base"},
  {id: "Cat.CartesianClosed.Base", label: "Cat.CartesianClosed.Base"},
  {id: "Cat.CartesianClosed.Instances.PSh", label: "Cat.CartesianClosed.Instances.PSh"},
  {id: "Cat.CartesianClosed.Locally", label: "Cat.CartesianClosed.Locally"},
  {id: "Cat.Diagram.Coequaliser.RegularEpi", label: "Cat.Diagram.Coequaliser.RegularEpi"},
  {id: "Cat.Diagram.Coequaliser", label: "Cat.Diagram.Coequaliser"},
  {id: "Cat.Diagram.Colimit.Base", label: "Cat.Diagram.Colimit.Base"},
  {id: "Cat.Diagram.Congruence", label: "Cat.Diagram.Congruence"},
  {id: "Cat.Diagram.Coproduct.Indexed", label: "Cat.Diagram.Coproduct.Indexed"},
  {id: "Cat.Diagram.Coproduct", label: "Cat.Diagram.Coproduct"},
  {id: "Cat.Diagram.Duals", label: "Cat.Diagram.Duals"},
  {id: "Cat.Diagram.End", label: "Cat.Diagram.End"},
  {id: "Cat.Diagram.Equaliser.Kernel", label: "Cat.Diagram.Equaliser.Kernel"},
  {id: "Cat.Diagram.Equaliser.RegularMono", label: "Cat.Diagram.Equaliser.RegularMono"},
  {id: "Cat.Diagram.Equaliser", label: "Cat.Diagram.Equaliser"},
  {id: "Cat.Diagram.Everything", label: "Cat.Diagram.Everything"},
  {id: "Cat.Diagram.Idempotent", label: "Cat.Diagram.Idempotent"},
  {id: "Cat.Diagram.Image", label: "Cat.Diagram.Image"},
  {id: "Cat.Diagram.Initial", label: "Cat.Diagram.Initial"},
  {id: "Cat.Diagram.Limit.Base", label: "Cat.Diagram.Limit.Base"},
  {id: "Cat.Diagram.Limit.Equaliser", label: "Cat.Diagram.Limit.Equaliser"},
  {id: "Cat.Diagram.Limit.Finite", label: "Cat.Diagram.Limit.Finite"},
  {id: "Cat.Diagram.Limit.Product", label: "Cat.Diagram.Limit.Product"},
  {id: "Cat.Diagram.Limit.Pullback", label: "Cat.Diagram.Limit.Pullback"},
  {id: "Cat.Diagram.Monad.Limits", label: "Cat.Diagram.Monad.Limits"},
  {id: "Cat.Diagram.Monad", label: "Cat.Diagram.Monad"},
  {id: "Cat.Diagram.Product.Indexed", label: "Cat.Diagram.Product.Indexed"},
  {id: "Cat.Diagram.Product", label: "Cat.Diagram.Product"},
  {id: "Cat.Diagram.Pullback.Properties", label: "Cat.Diagram.Pullback.Properties"},
  {id: "Cat.Diagram.Pullback", label: "Cat.Diagram.Pullback"},
  {id: "Cat.Diagram.Pushout", label: "Cat.Diagram.Pushout"},
  {id: "Cat.Diagram.Sieve", label: "Cat.Diagram.Sieve"},
  {id: "Cat.Diagram.Terminal", label: "Cat.Diagram.Terminal"},
  {id: "Cat.Diagram.Zero", label: "Cat.Diagram.Zero"},
  {id: "Cat.Displayed.Base", label: "Cat.Displayed.Base"},
  {id: "Cat.Displayed.Cartesian", label: "Cat.Displayed.Cartesian"},
  {id: "Cat.Displayed.Instances.Family", label: "Cat.Displayed.Instances.Family"},
  {id: "Cat.Displayed.Instances.Slice", label: "Cat.Displayed.Instances.Slice"},
  {id: "Cat.Displayed.Total", label: "Cat.Displayed.Total"},
  {id: "Cat.Functor.Adjoint.Compose", label: "Cat.Functor.Adjoint.Compose"},
  {id: "Cat.Functor.Adjoint.Continuous", label: "Cat.Functor.Adjoint.Continuous"},
  {id: "Cat.Functor.Adjoint.Hom", label: "Cat.Functor.Adjoint.Hom"},
  {id: "Cat.Functor.Adjoint.Monad", label: "Cat.Functor.Adjoint.Monad"},
  {id: "Cat.Functor.Adjoint.Monadic", label: "Cat.Functor.Adjoint.Monadic"},
  {id: "Cat.Functor.Adjoint.Reflective", label: "Cat.Functor.Adjoint.Reflective"},
  {id: "Cat.Functor.Adjoint", label: "Cat.Functor.Adjoint"},
  {id: "Cat.Functor.Amnestic", label: "Cat.Functor.Amnestic"},
  {id: "Cat.Functor.Base", label: "Cat.Functor.Base"},
  {id: "Cat.Functor.Bifunctor", label: "Cat.Functor.Bifunctor"},
  {id: "Cat.Functor.Conservative", label: "Cat.Functor.Conservative"},
  {id: "Cat.Functor.Equivalence.Complete", label: "Cat.Functor.Equivalence.Complete"},
  {id: "Cat.Functor.Equivalence", label: "Cat.Functor.Equivalence"},
  {id: "Cat.Functor.Everything", label: "Cat.Functor.Everything"},
  {id: "Cat.Functor.FullSubcategory", label: "Cat.Functor.FullSubcategory"},
  {id: "Cat.Functor.Hom", label: "Cat.Functor.Hom"},
  {id: "Cat.Functor.Kan.Nerve", label: "Cat.Functor.Kan.Nerve"},
  {id: "Cat.Functor.Kan", label: "Cat.Functor.Kan"},
  {id: "Cat.Functor.Pullback", label: "Cat.Functor.Pullback"},
  {id: "Cat.Functor.Reasoning", label: "Cat.Functor.Reasoning"},
  {id: "Cat.Functor.Slice", label: "Cat.Functor.Slice"},
  {id: "Cat.Instances.Comma.Univalent", label: "Cat.Instances.Comma.Univalent"},
  {id: "Cat.Instances.Comma", label: "Cat.Instances.Comma"},
  {id: "Cat.Instances.Delooping", label: "Cat.Instances.Delooping"},
  {id: "Cat.Instances.Discrete", label: "Cat.Instances.Discrete"},
  {id: "Cat.Instances.Elements", label: "Cat.Instances.Elements"},
  {id: "Cat.Instances.FinSet", label: "Cat.Instances.FinSet"},
  {id: "Cat.Instances.Functor.Duality", label: "Cat.Instances.Functor.Duality"},
  {id: "Cat.Instances.Functor.Limits", label: "Cat.Instances.Functor.Limits"},
  {id: "Cat.Instances.Functor", label: "Cat.Instances.Functor"},
  {id: "Cat.Instances.Karoubi", label: "Cat.Instances.Karoubi"},
  {id: "Cat.Instances.Lift", label: "Cat.Instances.Lift"},
  {id: "Cat.Instances.Product", label: "Cat.Instances.Product"},
  {id: "Cat.Instances.Sets.CartesianClosed", label: "Cat.Instances.Sets.CartesianClosed"},
  {id: "Cat.Instances.Sets.Cocomplete", label: "Cat.Instances.Sets.Cocomplete"},
  {id: "Cat.Instances.Sets.Complete", label: "Cat.Instances.Sets.Complete"},
  {id: "Cat.Instances.Sets.Congruences", label: "Cat.Instances.Sets.Congruences"},
  {id: "Cat.Instances.Sets", label: "Cat.Instances.Sets"},
  {id: "Cat.Instances.Shape.Cospan", label: "Cat.Instances.Shape.Cospan"},
  {id: "Cat.Instances.Shape.Interval", label: "Cat.Instances.Shape.Interval"},
  {id: "Cat.Instances.Shape.Join", label: "Cat.Instances.Shape.Join"},
  {id: "Cat.Instances.Shape.Parallel", label: "Cat.Instances.Shape.Parallel"},
  {id: "Cat.Instances.Shape.Terminal", label: "Cat.Instances.Shape.Terminal"},
  {id: "Cat.Instances.Slice.Presheaf", label: "Cat.Instances.Slice.Presheaf"},
  {id: "Cat.Instances.Slice", label: "Cat.Instances.Slice"},
  {id: "Cat.Instances.StrictCat.Cohesive", label: "Cat.Instances.StrictCat.Cohesive"},
  {id: "Cat.Instances.StrictCat", label: "Cat.Instances.StrictCat"},
  {id: "Cat.Morphism", label: "Cat.Morphism"},
  {id: "Cat.Prelude", label: "Cat.Prelude"},
  {id: "Cat.Reasoning", label: "Cat.Reasoning"},
  {id: "Cat.Solver", label: "Cat.Solver"},
  {id: "Cat.Thin.Completion", label: "Cat.Thin.Completion"},
  {id: "Cat.Thin.Instances.Sub", label: "Cat.Thin.Instances.Sub"},
  {id: "Cat.Thin.Limits", label: "Cat.Thin.Limits"},
  {id: "Cat.Thin", label: "Cat.Thin"},
  {id: "Cat.Univalent.Instances.Algebra", label: "Cat.Univalent.Instances.Algebra"},
  {id: "Cat.Univalent.Rezk", label: "Cat.Univalent.Rezk"},
  {id: "Cat.Univalent", label: "Cat.Univalent"},
  {id: "Data.Bool", label: "Data.Bool"},
  {id: "Data.Fin.Base", label: "Data.Fin.Base"},
  {id: "Data.Fin.Closure", label: "Data.Fin.Closure"},
  {id: "Data.Fin.Properties", label: "Data.Fin.Properties"},
  {id: "Data.Fin", label: "Data.Fin"},
  {id: "Data.Int.Inductive", label: "Data.Int.Inductive"},
  {id: "Data.Int", label: "Data.Int"},
  {id: "Data.List", label: "Data.List"},
  {id: "Data.Nat.Base", label: "Data.Nat.Base"},
  {id: "Data.Nat.Properties", label: "Data.Nat.Properties"},
  {id: "Data.Nat", label: "Data.Nat"},
  {id: "Data.Power.Lattice", label: "Data.Power.Lattice"},
  {id: "Data.Power", label: "Data.Power"},
  {id: "Data.Set.Coequaliser", label: "Data.Set.Coequaliser"},
  {id: "Data.Set.Truncation", label: "Data.Set.Truncation"},
  {id: "Data.Sum", label: "Data.Sum"},
  {id: "Relation.Order.Lexicographic", label: "Relation.Order.Lexicographic"},
  {id: "Relation.Order", label: "Relation.Order"},
  {id: "Topoi.Base", label: "Topoi.Base"},
  {id: "Topoi.Classifying.Diaconescu", label: "Topoi.Classifying.Diaconescu"},
  {id: "Topoi.Reasoning", label: "Topoi.Reasoning"},
];
window.graphedges = [
